  ...
  return (
    <div className={styles.timer}>
      <div className={styles.numbers}>
        <span className={styles.span}>{("0" + Math.floor((time / 60000) % 60)).slice(-2)}:</span>
        <span className={styles.span}>{("0" + Math.floor((time / 1000) % 60)).slice(-2)}:</span>
        <span className={styles.span}>{("0" + ((time / 10) % 100)).slice(-3)}</span>
      </div>
